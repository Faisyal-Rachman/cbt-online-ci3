...
class Access{
	...
	function login($username, $password){
		...
		if($result){
			...
			if($password === $result->password){
				...
				$this->CI->session->set_userdata('cbt_keterangan',$result->keterangan);
	...
	function get_keterangan(){
		return $this->CI->session->userdata('cbt_keterangan');
	}
	...
	function logout(){
		...
		$this->CI->session->unset_userdata('cbt_keterangan');

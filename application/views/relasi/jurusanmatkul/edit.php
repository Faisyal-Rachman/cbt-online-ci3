<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <a href="<?=base_url()?>jurusanmatpel" class="btn btn-warning btn-flat btn-sm">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                    <?=form_open('jurusanmatpel/save', array('id'=>'jurusanmatpel'), array('method'=>'edit', 'matpel_id'=>$id_matpel))?>
...
<script src="<?=base_url()?>assets/dist/js/app/relasi/jurusanmatpel/edit.js"></script>
...
?>
            ...
            <div class="card-body table-responsive">
              ...
              <table id="table-sesi" class="table table-bordered table-striped table-sm">
			 ...
			 <h5 class="modal-title"><b>Tambah <?=$judul?></b></h5>
			  ...
			  <?php echo form_open($url.'/simpan','id="form-tambah"'); ?>
                ...
                <div class="form-group">
                        <label class="control-label col-xs-3" >Nama Sesi</label>
                        <div class="col-xs-8">
                            <input name="nama_sesi" id="nama_sesi" class="form-control" type="text" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Kode Sesi</label>
                        <div class="col-xs-8">
                            <input name="kode_sesi" id="kode_sesi" class="form-control" type="text" required>
                        </div>
                    </div>
...
<div class="modal" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-bodydelete">
        ...
        <div class="card card-primary">
            ...
            <!-- form start -->
            <form class="form" id="form-delete" action="<?php echo base_url()?>manager/data_sesi/hapus" method="post">
              <div class="card-body">
                <div class="form-group">
		...
		<div class="modal-content">
			<div class="modal-header">
			 <h5 class="modal-title"><b>Edit <?=$judul?></b></h5>
			  ...
			  <?=form_open('manager/data_sesi/simpanedit', array('id'=>'sesi'), array('mode'=>'add'))?>
                <div class="modal-body">
 
                     <div id="form-pesan"></div>
                  
                <div class="form-group">
                        <label class="control-label col-xs-3" >Edit Nama Sesi</label>
                        <div class="col-xs-8">
                        	 <input type="hidden" name="edit-id" id="edit-id">
                            <input name="enama_sesi" id="enama_sesi" class="form-control" type="text" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Edit Kode Sesi</label>
                        <div class="col-xs-8">
                            <input name="ekode_sesi" id="ekode_sesi" class="form-control" type="text" placeholder="Nama sesi" required>
                        </div>
                    </div>
 ...
 <script lang="javascript">
    function refresh_table(){
        $('#table-sesi').dataTable().fnReloadAjax();
    }
...
function image_preview2(posisi, image){
    ...
    function edit(id){
        $.getJSON('<?php echo site_url().''.$url; ?>/get_by_id/'+id+'', function(data){
            if(data.data==1){
                $('#edit-id').val(data.id);
                $('#enama_sesi').val(data.nr);
                $('#ekode_sesi').val(data.kr);

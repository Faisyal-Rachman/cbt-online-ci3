...
<div class="card d-flex justify-content-center">
 ...
 <div class="card-body">
        ...
        <div class="text-center">
            <a href="<?= base_url('uploads/import/format/sesiujian.xlsx') ?>" class="btn-default btn">Download Format</a>
        </div>
        <br>
        
        <div class="row d-flex justify-content-center">
      
            <?= form_open_multipart('manager/data_sesi/preview'); ?>
            ...
            <div class="col-lg-12 col-sm-offset-3">
                <?php if (isset($_POST['preview'])) : ?>
                        ...
                        <tbody>
                            <?php
                                if (empty($import)) {
                                    ...
                                    $no = 1;
                                    foreach ($import as $sesi) :
                                        ?>
                                    <tr>
                                   
                                        <td><?= $sesi['sesi_nama']; ?></td>
										 <td><?= $sesi['sesi_kode']; ?></td>
                                    </tr>
                            <?php
                                    endforeach;
                                }
                    ...
                    <?php if (!empty($import)) : ?>
                        ...
                        <?= form_open('manager/data_sesi/do_import', null, ['sesi' => json_encode($import)]); ?>

                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <?=form_hidden('id_matpel['.$no.']', $j->id_matpel)?>
                                    <input autofocus="autofocus" onfocus="this.select()" autocomplete="off" value="<?=$j->nama_matpel?>" type="text" name="nama_matpel[<?=$no?>]" class="input-sm form-control">

...
?>
            ...
            <div class="card-body table-responsive">
              ...
              <table id="table-matpel" class="table table-bordered table-striped table-sm">
			  ...
			  <?php echo form_open($url.'/simpan','id="form-tambah"'); ?>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="modul_aktif" id="modul_aktif" class="form-control" type="text" placeholder="1 / 0" required>
                        </div>
                    </div>
                <div class="form-group">
                        <label class="control-label col-xs-3" >KKM</label>
                        <div class="col-xs-8">
                            <input name="modul_kkm" id="modul_kkm" class="form-control" type="text" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Nama Mata Pelajaran</label>
                        <div class="col-xs-8">
                            <input name="modul_nama" id="modul_nama" class="form-control" type="text" placeholder="Nama matpel" required>
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="modul_kode" id="modul_kode" class="form-control" type="text" placeholder="Kode matpel" required>
                        </div>
                    </div>
...
<div class="modal" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-bodydelete">
        ...
        <div class="card card-primary">
            ...
            <!-- form start -->
            <form class="form" id="form-delete" action="<?php echo base_url()?>manager/data_mapel/hapus" method="post">
              <div class="card-body">
                <div class="form-group">
                ...
                <div class="card-footer">
                  <button id="submit" type="submit" class="btn btn-danger">Hapus</button>
		...
		<div class="modal-content">
			<div class="modal-header">
			 <h5 class="modal-title"><b>Edit <?=$judul?></b></h5>
			  ...
			  <?=form_open('manager/data_mapel/simpanedit', array('id'=>'matpel'), array('mode'=>'add'))?>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            ...
                            <input name="modul_aktif" id="emodul_aktif" class="form-control" type="text" placeholder="1 / 0" required>
                        </div>
                    </div>
                <div class="form-group">
                        <label class="control-label col-xs-3" >Edit KKM</label>
                        <div class="col-xs-8">
                            <input name="modul_kkm" id="emodul_kkm" class="form-control" type="text" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Edit Nama Mapel</label>
                        <div class="col-xs-8">
                            <input name="modul_nama" id="emodul_nama" class="form-control" type="text" placeholder="Nama matpel" required>
                        </div>
                    </div>
  <div class="form-group">
                        <label class="control-label col-xs-3" >Edit Kode Mapel</label>
                        <div class="col-xs-8">
                            <input name="modul_kode" id="emodul_kode" class="form-control" type="text" placeholder="Nama matpel" required>
                        </div>
                    </div>
 ...
 <script lang="javascript">
    function refresh_table(){
        $('#table-matpel').dataTable().fnReloadAjax();
    }
    ...
    function tambah(){
        ...
        $('#tambah-username').focus();
         CKEDITOR.instances.ket.setData('');
        $.clearInput();
        imageUpload();
    }
...
function image_preview2(posisi, image){
    ...
    function edit(id){
        $.getJSON('<?php echo site_url().'/'.$url; ?>/get_by_id/'+id+'', function(data){
            if(data.data==1){
                $('#edit-id').val(data.id);
                $('#emodul_nama').val(data.modul);
               $('#emodul_aktif').val(data.stat);
                $('#emodul_kode').val(data.kode);
                $('#emodul_kkm').val(data.kkm);

			  ...
			  <?=form_open('manager/data_mapel/simpanedit', array('id'=>'matpel'), array('mode'=>'add'))?>
                <div class="modal-body">
                     ...
                     <div id="form-pesan"></div>
                            ...
                            <input name="modul_aktif" id="emodul_aktif" class="form-control" type="hidden">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Nama Mapel</label>
                        <div class="col-xs-8">
...
if(confirm("Anda yakin mapel di "+ msg)){
    var current_element = $(this);
     url = "<?php echo base_url(); ?>index.php/manager/data_mapel/update",
    $.ajax({
    type:"POST",
    url: url,

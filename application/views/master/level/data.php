...
?>
            ...
            <div class="card-body table-responsive">
              ...
              <table id="table-level" class="table table-bordered table-striped table-sm">
			 ...
			 <h5 class="modal-title"><b>Tambah <?=$judul?></b></h5>
			  ...
			  <?php echo form_open($url.'/simpan','id="form-tambah"'); ?>
                ...
                <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="nama_level" id="nama_level" class="form-control" type="text" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Kode Level</label>
                        <div class="col-xs-8">
                            <input name="kode_level" id="kode_level" class="form-control" type="text" required>
                        </div>
                    </div>
...
<div class="modal" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-bodydelete">
        ...
        <div class="card card-primary">
            ...
            <!-- form start -->
            <form class="form" id="form-delete" action="<?php echo base_url()?>manager/data_level/hapus" method="post">
              <div class="card-body">
                <div class="form-group">
		...
		<div class="modal-content">
			<div class="modal-header">
			 <h5 class="modal-title"><b>Edit <?=$judul?></b></h5>
			  ...
			  <?=form_open('manager/data_level/simpanedit', array('id'=>'level'), array('mode'=>'add'))?>
                <div class="modal-body">
 
                     <div id="form-pesan"></div>
                  
                <div class="form-group">
                        <label class="control-label col-xs-3" >Edit Nama Level</label>
                        <div class="col-xs-8">
                        	 <input type="hidden" name="edit-id" id="edit-id">
                            <input name="enama_level" id="enama_level" class="form-control" type="text" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Edit Kode Level</label>
                        <div class="col-xs-8">
                            <input name="ekode_level" id="ekode_level" class="form-control" type="text" placeholder="Nama level" required>
                        </div>
                    </div>
 ...
 <script lang="javascript">
    function refresh_table(){
        $('#table-level').dataTable().fnReloadAjax();
    }
...
function image_preview2(posisi, image){
    ...
    function edit(id){
        $.getJSON('<?php echo site_url().''.$url; ?>/get_by_id/'+id+'', function(data){
            if(data.data==1){
                $('#edit-id').val(data.id);
                $('#enama_level').val(data.nr);
                $('#ekode_level').val(data.kr);

...
?>
            ...
            <div class="card-body table-responsive">
              ...
              <table id="table-kelas" class="table table-bordered table-striped table-sm">
			 ...
			 <h5 class="modal-title"><b>Tambah <?=$judul?></b></h5>
			  ...
			  <?php echo form_open($url.'/simpan','id="form-tambah"'); ?>
                ...
                <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="nama_kelas" id="nama_kelas" class="form-control" type="text" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Tingkat Kelas</label>
                      <div id="data-kelas">
...
<div class="modal" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-bodydelete">
        ...
        <div class="card card-primary">
            ...
            <!-- form start -->
            <form class="form" id="form-delete" action="<?php echo base_url()?>manager/data_kelas/hapus" method="post">
              <div class="card-body">
                <div class="form-group">
		...
		<div class="modal-content">
			<div class="modal-header">
			 <h5 class="modal-title"><b>Edit <?=$judul?></b></h5>
			  ...
			  <?=form_open('manager/data_kelas/simpanedit', array('id'=>'kelas'), array('mode'=>'add'))?>
                <div class="modal-body">
 
                     <div id="form-pesan"></div>
                  
                <div class="form-group">
                        <label class="control-label col-xs-3" >Edit Nama Kelas</label>
                        <div class="col-xs-8">
                        	 <input type="hidden" name="edit-id" id="edit-id">
                            <input name="enama_kelas" id="enama_kelas" class="form-control" type="text" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Edit Kode Kelas</label>
                        <div class="col-xs-8">
                          <div id="data-kelas">
                                <select name="ekode_kelas" id="ekode_kelas" class="form-control input-sm">
                                    <option value="semua">Semua Kelas</option>
                                    <?php if(!empty($select_group)){ echo $select_group; } ?>
                                </select>
                            </div>
 ...
 <script lang="javascript">
    function refresh_table(){
        $('#table-kelas').dataTable().fnReloadAjax();
    }
...
function image_preview2(posisi, image){
    ...
    function edit(id){
        $.getJSON('<?php echo site_url().'/'.$url; ?>/get_by_id/'+id+'', function(data){
            if(data.data==1){
                $('#edit-id').val(data.id);
                $('#enama_kelas').val(data.ng);
                $('#ekode_kelas').val(data.kg);

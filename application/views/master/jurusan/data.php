...
?>
 ...
 <div class="card-body table-responsive">
              ...
              <table id="table-jurusan" class="table table-bordered table-striped table-sm">
	...
	<div class="modal-dialog modal-notify modal-info modal-md">
		...
		<div class="modal-header bg-primary">
			 <h5 class="modal-title"><b>Tambah <?=$judul?></b></h5>
			  ...
			  <?=form_open('manager/data_jurusan/simpan', array('id'=>'form-tambah'), array('mode'=>'add'))?>
                <div class="modal-body">
 
                    <div class="form-group">
                        <label class="control-label col-xs-3">NAMA JURUSAN</label>
                        <div class="col-xs-8">
                            <input name="jurusan_nama" id="jurusan_nama" class="form-control" type="text" placeholder="Nama jurusan..." required>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="control-label col-xs-3">KODE JURUSAN</label>
                        <div class="col-xs-8">
                            <input name="jurusan_kode" id="jurusan_kode" class="form-control" type="text" placeholder="Kode jurusan..." required>
                        </div>
                    </div>
     </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-bodydelete">
        ...
        <div class="card card-primary">
            ...
            <!-- form start -->
            <form class="form" id="form-delete" action="<?php echo base_url()?>manager/data_jurusan/hapus" method="post">
              <div class="card-body">
                <div class="form-group">
		...
		<div class="modal-content">
			<div class="modal-header">
			 <h5 class="modal-title"><b>Edit <?=$judul?></b></h5>
			  ...
			  <?=form_open('manager/data_jurusan/simpanedit', array('id'=>'jurusan'), array('mode'=>'add'))?>
                <div class="modal-body">
 
                     <div id="form-pesan"></div>
                  
                <div class="form-group">
                        <label class="control-label col-xs-3" >Edit Nama Jurusan</label>
                        <div class="col-xs-8">
                        	 <input type="hidden" name="edit-id" id="edit-id">
                            <input name="enama_jurusan" id="enama_jurusan" class="form-control" type="text" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Edit Kode Jurusan</label>
                        <div class="col-xs-8">
                            <input name="ekode_jurusan" id="ekode_jurusan" class="form-control" type="text" placeholder="Nama jurusan" required>
                        </div>
                    </div>
...
<script lang="javascript">
    function refresh_table(){
        $('#table-jurusan').dataTable().fnReloadAjax();
    }
...
function image_preview2(posisi, image){
    ...
    function edit(id){
        $.getJSON('<?php echo site_url().''.$url; ?>/get_by_id/'+id+'', function(data){
            if(data.data==1){
                $('#edit-id').val(data.id);
                $('#enama_jurusan').val(data.nr);
                $('#ekode_jurusan').val(data.kr);

                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <?=form_hidden('id_matkul', $row->id_matkul)?>
                                    <input autofocus="autofocus" onfocus="this.select()" autocomplete="off" value="<?=$row->nama_matkul?>" type="text" name="nama_matkul" class="input-sm form-control">

...
<div class="card d-flex justify-content-center">
 ...
 <div class="card-body">
        ...
        <div class="text-center">
            <a href="<?= base_url('uploads/import/format/jenisujian.xlsx') ?>" class="btn-default btn">Download Format</a>
        </div>
        <br>
        
        <div class="row d-flex justify-content-center">
      
            <?= form_open_multipart('jenisujian/preview'); ?>
            ...
            <div class="col-lg-12 col-sm-offset-3">
                <?php if (isset($_POST['preview'])) : ?>
                        ...
                        <tbody>
                            <?php
                                if (empty($import)) {
                                    ...
                                    $no = 1;
                                    foreach ($import as $jenisujian) :
                                        ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= $jenisujian['kode_jenisujian']; ?></td>
										 <td><?= $jenisujian['nama_jenisujian']; ?></td>
                                    </tr>
                            <?php
                                    endforeach;
                                }
                    ...
                    <?php if (!empty($import)) : ?>
                        ...
                        <?= form_open('jenisujian/do_import', null, ['jenisujian' => json_encode($import)]); ?>

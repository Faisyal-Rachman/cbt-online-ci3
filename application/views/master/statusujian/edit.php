           ...
           <div class="col-md-6">
                ...
                <table id="form-table" class="table text-center table-condensed">
                    ...
                    <tbody>
						...
						<?=form_hidden('modul_id', $row->modul_id)?>
                        <tr>
                            <td><div class="form-group">
                                    <input autofocus="autofocus" onfocus="this.select()" autocomplete="off" value="<?=$row->modul_aktif?>" type="text" name="modul_aktif" class="input-sm form-control">
                                    <small class="help-block text-right"></small>
                                </div></td>
                            <td>
                                <div class="form-group">
                                    <input autofocus="autofocus" onfocus="this.select()" autocomplete="off" value="<?=$row->modul_nama?>" type="text" name="modul_nama" class="input-sm form-control">
                                    <small class="help-block text-right"></small>
                                </div>

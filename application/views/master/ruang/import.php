...
<div class="card d-flex justify-content-center">
 ...
 <div class="card-body">
        ...
        <div class="text-center">
            <a href="<?= base_url('uploads/import/format/ruangujian.xlsx') ?>" class="btn-default btn">Download Format</a>
        </div>
        <br>
        
        <div class="row d-flex justify-content-center">
      
            <?= form_open_multipart('manager/data_ruang/preview'); ?>
            ...
            <div class="col-lg-12 col-sm-offset-3">
                <?php if (isset($_POST['preview'])) : ?>
                    ...
                    <?php if (!empty($import)) : ?>
                        ...
                        <?= form_open('manager/data_ruang/do_import', null, ['ruang' => json_encode($import)]); ?>

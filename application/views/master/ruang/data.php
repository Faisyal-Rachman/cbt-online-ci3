...
?>
            ...
            <div class="card-body table-responsive">
              ...
              <table id="table-ruang" class="table table-bordered table-striped table-sm">
			 ...
			 <h5 class="modal-title"><b>Tambah <?=$judul?></b></h5>
			  ...
			  <?php echo form_open($url.'/simpan','id="form-tambah"'); ?>
                ...
                <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="nama_ruang" id="nama_ruang" class="form-control" type="text" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Kode Ruang</label>
                        <div class="col-xs-8">
                            <input name="kode_ruang" id="kode_ruang" class="form-control" type="text" required>
                        </div>
                    </div>
...
<div class="modal" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-bodydelete">
        ...
        <div class="card card-primary">
            ...
            <!-- form start -->
            <form class="form" id="form-delete" action="<?php echo base_url()?>manager/data_ruang/hapus" method="post">
              <div class="card-body">
                <div class="form-group">
		...
		<div class="modal-content">
			<div class="modal-header">
			 <h5 class="modal-title"><b>Edit <?=$judul?></b></h5>
			  ...
			  <?=form_open('manager/data_ruang/simpanedit', array('id'=>'ruang'), array('mode'=>'add'))?>
                <div class="modal-body">
 
                     <div id="form-pesan"></div>
                  
                <div class="form-group">
                        <label class="control-label col-xs-3" >Edit Nama Ruang</label>
                        <div class="col-xs-8">
                        	 <input type="hidden" name="edit-id" id="edit-id">
                            <input name="enama_ruang" id="enama_ruang" class="form-control" type="text" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Edit Kode Ruang</label>
                        <div class="col-xs-8">
                            <input name="ekode_ruang" id="ekode_ruang" class="form-control" type="text" required>
                        </div>
                    </div>
 ...
 <script lang="javascript">
    function refresh_table(){
        $('#table-ruang').dataTable().fnReloadAjax();
    }
...
function image_preview2(posisi, image){
    ...
    function edit(id){
        $.getJSON('<?php echo site_url().'/'.$url; ?>/get_by_id/'+id+'', function(data){
            if(data.data==1){
                $('#edit-id').val(data.id);
                $('#enama_ruang').val(data.nr);
                $('#ekode_ruang').val(data.kr);

...
<section class="content">
    ...
    <div class="container-fluid">
            <div class="callout callout-info">
                <h4>Informasi</h4>
                <p>Export / Import dapat digunakan untuk mendistribusikan Soal yang sudah di entry.</p>
                <p>Pastikan sebelum melakukan Import Data Soal tidak ada Topik.</p>
            </div>
        </div>
    </div>
    <div class="row">
	...
	<div class="row">
		<div class="col-md-6">
                <div class="card">
                    <div class="card-header with-border">
    					<div class="card-title">Export Data Soal</div>
                    </div><!-- /.card-header -->
        ...
        <div class="col-md-6">
            <?php echo form_open_multipart($url.'/importsoal','id="form-import"'); ?>
                <div class="card">
                    <div class="card-header with-border">
    					<div class="card-title">Import Data Soal</div>
                    </div><!-- /.card-header -->

                  ...
                  <div class="row">
                     <div class="col-sm-4">
                        <div class="form-group">
                            <label class="col-sm-10 control-label">Peringkat</label>
                            <div class="col-sm-10">
                                <select name="pilih-group" id="pilih-group" class="form-control input-sm">
                                    <option value="peringkat1">Peringkat 1</option>
                                    <option value="peringkat2">Peringkat 2</option>
                                     <option value="peringkat3">Peringkat 3</option>
                                </select>
                            </div>
                        </div>
                        </div>
                        <div class="col-sm-4">
                        <div class="form-group">
                            <label class="col-sm-10 control-label">Jurusan</label>
                            <div class="col-sm-12">
                                <input type="hidden" name="check" id="check" value="0">
                                <select name="pilih-jur" id="pilih-jur" class="form-control input-sm">

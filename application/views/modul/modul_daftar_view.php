...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Daftar soal dan jawaban berdasarkan Modul dan Topik</li>
	</ol>
</section>
                    ...
                    <div class="form-group">
                        ...
                        <div class="card-tools pull-right">
                            <div class="dropdown pull-right">
                                <a class="btn btn-block btn-outline-warning btn-flat" style="cursor: pointer;" onclick="cetak_soal()">Cetak Daftar Soal</a>
                            </div>
                        </div>
                    </div><!-- /.card-header -->

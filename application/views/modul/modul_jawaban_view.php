...
<section class="content-header">
	<h1>
		Kelola Jawaban dari Topik <small><?php if(!empty($topik)){ echo $topik; } ?></small>
...
<section class="content">
    ...
    <div class="container-fluid">
            <div class="card">
               <div class="card-body">
                    <div class="col-xs-12"><label><b>Pertanyaan : </b></label>
    ...
    <div class="card-body">
                <div class="col-xs-20">
                    ...
                    <div class="card-title"><a href="<?php echo site_url(); ?>/manager/modul_soal" class="btn btn-outline-primary btn-sm" style="cursor: pointer;">Kembali Ke Soal</a></div>
                    </div><!-- /.card-header -->

                    
                        <table id="table-jawaban" class="table table-bordered table-hover table-sm">

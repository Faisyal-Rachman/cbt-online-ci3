...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Menyesuaikan dengan nama Mapel dan Topik dari Soal</li>
    </ol>
</section>
            ...
            <?php echo form_open_multipart($url.'/upload_file','id="form-upload" class="form-horizontal"'); ?>
                <div class="card">
                        ...
                        <div class="row-fluid">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Pilih file untuk diupload</label>
                                    <div class="col-sm-10">
                                        <input type="hidden" name="upload-posisi" id="upload-posisi">
                                        <input type="file" id="upload-file" name="upload-file" >
                                        <p class="help-block">File yang didukung adalah mp3, jpg, jpeg, png</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="submit" id="btn-upload" class="btn btn-info">Upload File</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="col-md-6">
            <?php echo form_open_multipart($url.'/tambah_dir','id="form-tambah" class="form-horizontal"'); ?>
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row-fluid">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Direktori upload manual</label>
                                    <div class="col-sm-10">
                                        ...
                                        <p class="help-block"><small>Harap perhatikan penulisan Mapel dan Topik Soal</small>.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="submit" id="btn-tambah" class="btn btn-info">Buat Direktori</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="container-fluid">
                <div class="card">
                    <div class="card-header with-border">
    						<div class="card-title text-danger">Folder : <a style="cursor:pointer;" onclick="open_home_dir()">Uploads</a>*<span id="posisi-file-judul"></span></div>
    						<div class="card-tools pull-right">
    							<div class="dropdown pull-right">
    								<a class="btn btn-block btn-outline-primary btn-flat" style="cursor: pointer;" onclick="refresh_table()">Refresh Data</a>
    							</div>
    						</div>
                    </div><!-- /.card-header -->
                    ...
                    <div class="card-body">
                        ...
                        <table id="table-file" class="table table-bordered table-hover table-sm">

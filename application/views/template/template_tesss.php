  ...
  <body class="skin-green layout-top-nav">
    <div class="wrapper">
        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              <a href="<?php echo base_url(); ?>" class="navbar-brand"> <b>Computer Basddded-Test</b></a>
            </div>
      ...
      <footer class="main-footer no-print">
        ...
        <div class="container">
          <strong>&copy; 2017 achmadlutfi.wordpress.com</strong>
        </div><!-- /.container -->
      </footer>
    </div><!-- ./wrapper -->
  ...
  <script type="text/javascript">
    $(function () {
        ...
        setInterval(function() {
          endTime = new Date();
          timeDiff = endTime.getTime() - serverTime;

          var date = new Date();
          date.setTime(serverTime + timeDiff);

...
<link rel="stylesheet" href="<?=base_url()?>public/plugins/AdminLTE3/plugins/select2-bootstrap4-theme/select2-bootstrap4.css">
<link rel="stylesheet" href="<?=base_url()?>public/plugins/AdminLTE3/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
    ...
    <script src="<?=base_url()?>assets/bower_components2/jquery/jquery-3.3.1.min.js"></script>
<script src="<?=base_url()?>assets/bower_components2/sweetalert2/sweetalert2.all.min.js"></script>
<script src="<?=base_url()?>assets/bower_components2/select2/js/select2.full.min.js"></script>
<script src="<?=base_url()?>assets/bower_components2/moment/min/moment.min.js"></script>
...
<!-- BS 3 -->
  ...
  z-index: 2;
      ...
      .main-sidebar{background-color: #003366 !important;
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url('index.php/manager/dashboard'); ?>" class="nav-link">Beranda</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url('index.php/manager/data_bacara'); ?>" class="nav-link">Berita Acara Ujian</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
     ...
     <b> [ <?php echo $nama;?>  @  <?php echo $keterangan;?> ]</b>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?php echo base_url(); ?>public/plugins/adminlte/img/avatar04.png" alt="User Avatar" class="img-size-50 mr-3 img-circle">
              <div class="media-body">
                ...
                <p class="text-sm">Sampai jumpa...</p>
          ...
          <a href="<?php echo site_url(); ?>/manager/welcome/logout" class="dropdown-item dropdown-footer">Sign Out</a>
        </div>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        ...
        <img src="<?php echo base_url(); ?>assets/img/<?php echo $gambar->row()->konfigurasi_isi ?>" class="user-image" width="10%" alt="User Image" />
                
      <span class="brand-text font-weight-light"><?php if(!empty($site_name)){ echo $site_name; } ?></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo base_url(); ?>public/images/avatar.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block"><?php if(!empty($nama)){ echo $nama; }else{ echo 'Administrator'; } ?></a>
        </div>
      </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="http://adminlte.io"><?php if(!empty($site_name)){ echo $site_name; } ?></a></strong>
...
<script src="<?php echo base_url(); ?>public/plugins/AdminLTE3/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- ChartJS -->
<script src="<?php echo base_url(); ?>public/plugins/AdminLTE3/plugins/chart.js/Chart.min.js"></script>
<!-- Sparkline -->
<script src="<?php echo base_url(); ?>public/plugins/AdminLTE3/plugins/sparklines/sparkline.js"></script>
<!-- JQVMap -->
<script src="<?php echo base_url(); ?>public/plugins/AdminLTE3/plugins/jqvmap/jquery.vmap.min.js"></script>
<script src="<?php echo base_url(); ?>public/plugins/AdminLTE3/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url(); ?>public/plugins/AdminLTE3/plugins/jquery-knob/jquery.knob.min.js"></script>
<!-- daterangepicker -->

<script src="<?php echo base_url(); ?>public/plugins/AdminLTE3/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Summernote -->
<script src="<?php echo base_url(); ?>public/plugins/AdminLTE3/plugins/summernote/summernote-bs4.min.js"></script>
<!-- overlayScrollbars -->
...
<!-- AdminLTE for demo purposes -->
<script src="<?= base_url() ?>assets/bower_components2/datatables.net-bs/plugins/Buttons-1.5.6/js/dataTables.buttons.min.js"></script>
			<script src="<?= base_url() ?>assets/bower_components2/datatables.net-bs/plugins/pdfmake-0.1.36/pdfmake.min.js"></script>
			<script src="<?= base_url() ?>assets/bower_components2/datatables.net-bs/plugins/pdfmake-0.1.36/vfs_fonts.js"></script>
			<script src="<?= base_url() ?>assets/bower_components2/datatables.net-bs/plugins/Buttons-1.5.6/js/buttons.html5.min.js"></script>
				<script src="<?= base_url() ?>assets/bower_components/datatables.net-buttons/js/buttons.print.min.js"></script>
			<script src="<?= base_url() ?>assets/bower_components/datatables.net-buttons/js/buttons.colVis.min.js"></script>

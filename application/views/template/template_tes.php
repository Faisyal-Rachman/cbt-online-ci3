...
<link rel="stylesheet" href="<?=base_url()?>public/plugins/AdminLTE3/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
 ...
 <!-- Datatables Buttons -->
   ...
   -->
<!-- summernote dimatikan
   ONSEN UI CONFLIC DENGAN MODAL JS
   -->
...
<!-- Navbar -->
 <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <b><?php if(!empty($site_name)){ echo $site_name; } ?></b>
      </li>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?php echo site_url(); ?>welcome/logout" class="dropdown-item dropdown-footer">Sign Out</a>
        </div>
      </li>
 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="<?php echo base_url(); ?>public/images/avatar.png" class="img-circle" alt="User Image">
        </div>
      <div class="info">
        <a href="#" class="d-block"><?php if(!empty($nama)){ echo $nama; }else{ echo 'Peserta'; } ?></a>
        <a href="#" class="d-block"><?php if(!empty($group)){ echo ' '.$group; } ?></a>
      </div>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        <!-- Add icons to the links using the .nav-icon class
             ...
             <li class="nav-item">
            <a href="<?php echo base_url(); ?>tes_dashboard" class="nav-link">
             ...
             <li class="nav-item">
            <a href="<?php echo base_url(); ?>tes_jadwal" class="nav-link">
              <i class="nav-icon far fa-circle text-info"></i>
              <p class="text">Jadwal Ujian</p>
            </a>
          </li>
    

             <li class="nav-item">
            <a href="<?php echo base_url(); ?>tes_sudah_ujian" class="nav-link">
              <i class="nav-icon far fa-circle text-info"></i>
              <p class="text">Histori Ujian</p>
            </a>
          </li>
    

          <li class="nav-item">
            <a href="<?php echo base_url(); ?>tes_hasil_detail/index/" class="nav-link">
              <i class="nav-icon far fa-circle text-info"></i>
              <p class="text">Nilai & Jawaban</p>
            </a>
          </li>
    ...
    function hentikan_tes(){
        ...
        $.getJSON('<?php echo site_url().'/'.$url; ?>/get_tes_info/'+$('#tes-id').val(), function(data){
            if(data.data==1){
                ...
                $('#hentikan-dijawab').val(data.tes_dijawab+" dijawab. "+data.tes_blum_dijawab+" belum.");

...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Hasilggg Tes</li>
	</ol>
</section>
    ...
    <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body form-horizontal">
                  <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="hidden" name="check" id="check" value="0">
                                <select id="pilih-jenis" name="pilih-jenis" class="form-control select2" style="width: 100%!important">
                        <option value="semua" selected="selected"></option>
                        <?php foreach ($jenis as $j) : ?>
                            <option value="<?=$j->tes_jenis?>"><?=$j->tes_jenis?></option>
                        <?php endforeach; ?>
                    </select>
                            </div>
                        </div>
              ...
              <div class="col-sm-6">
						...
						<div class="form-group">
                            <label class="col-sm-4 control-label">Ruang Ujian</label>
                            <div class="col-sm-8">
                            <select id="pilih-keterangan" name="pilih-keterangan" class="form-control select2" style="width: 100%!important">
                        <option value="semua" selected="selected"></option>
          ...
          <div class="card-footer">
                    <button type="button" id="btn-pilih" class="btn btn-primary pull-right"><span>Tampilkan</span></button>
                </div>
        ...
        <?php echo form_open($url.'/edit_tes','id="form-edit"'); ?>
			...
			<div class="card">
                ...
                <div class="card-footer">
                    ...
                    <button type="button" id="btn-edit-buka-tes" class="btn btn-info">Buka Tes</button>
    ...
    $(function(){
        ...
        $('#table-hasil').DataTable({
                  ...
                  "fnServerParams": function ( aoData ) {
                    ...
                    aoData.push( { "name": "jenis", "value": $('#pilih-jenis').val()} );

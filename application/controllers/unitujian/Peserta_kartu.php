		...
		if(!empty($grup_id)){
			...
			if($query_user->num_rows()>0){
				...
				foreach($query_user AS $temp){
					$kartu = $kartu.'
					<div class="kartu">
  <img src="'.$kp.'" alt="Snow" style="width:100%;">
 
  <div class="centered"><div class="header"><img src="'.$bgimg.'" width="100px"><br>'.$cbt_nama.'</div><hr />
							
  <table>
	  <tr>
		  <td width="95px"><b>Nama</td>
		  <td width="5px">:</td>
		  <td width="210px">'.$temp->user_firstname.'</b></td>
	  </tr>
	  <tr>
		  <td><b>Username</td>
		  <td>:</td>
		  <td>'.$temp->user_name.'</b></td>
	  </tr>
	  <tr>
		  <td><b>Password</td>
		  <td>:</td>
		  <td>'.$temp->user_password.'</b></td>
	  </tr>
	  <tr>
		  <td><b>Grup</td>
		  <td>:</td>

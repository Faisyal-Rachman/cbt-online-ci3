...
class Modul_topik extends Member_Controller {
    ...
    function get_datatable(){
	    ...
	    foreach ($query as $temp) {			
			...
			*/
			$record[] = '<table align="center"><tr><td><form action="http://localhost/ujiancbtnew/index.php/manager/modul_import" method="post" target="_blank"><input type="hidden" name="idtopik" value="'.$temp->topik_id.'"><input type="hidden" name="nmtopik" value="'.$temp->topik_nama.'">
				<button type="submit" class="btn btn-info btn-sm">Import</button></form></td><td>
				<form action="http://localhost/ujiancbtnew/index.php/manager/modul_soal" method="post" target="_blank"><input type="hidden" name="idtopik" value="'.$temp->topik_id.'"><input type="hidden" name="nmtopik" value="'.$temp->topik_nama.'">

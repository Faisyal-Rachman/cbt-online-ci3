    ...
    <div class="accordion" id="accordionExample">
        <div class="card text-white link-white">
            <div class="card-header" id="heading'.$i.'">
                <h2 class="mb-'.$i.'"><button type="button" class="btn btn-link" data-toggle="collapse" data-target="#collapse'.$i.'"><input type="checkbox" id="tambah-benar'.$i.'" name="tambah_benar['.$i.']" value="1"> <b>JAWABAN</b></button>
...
$tmnt = $tmp->topik_nama;
            ...
            if($temp->soal_tipe!=2 AND $temp->soal_tipe!=3){
            	$record[] = '<div style="text-align: center;">
	            	<p><a onclick="jawaban(\''.$temp->soal_id.'\')" title="Tambah Jawaban" style="cursor: pointer;"><i class="icon fa fa-plus-circle fa-1x"></i></a></p>
	            	<p><a onclick="edit(\''.$temp->soal_id.'\')" title="Edit Soal" style="cursor: pointer;"><i class="icon fa fa-edit fa-1x"></i></a></p>
	            	<a onclick="hapus(\''.$temp->soal_id.'\')" title="Hapus Soal" style="cursor: pointer;"><i class="icon fa fa-trash fa-1x"></i></a>
	            	</div>
	            ';
            }else{
            	$record[] = '<div style="text-align: center;">
	            	<a onclick="edit(\''.$temp->soal_id.'\')" title="Edit Soal" style="cursor: pointer;"><i class="icon fa fa-edit fa-1x"></i></a>
	            	<a onclick="hapus(\''.$temp->soal_id.'\')" title="Hapus Soal" style="cursor: pointer;"><i class="icon fa fa-trash fa-1x"></i></a>
	            	</div>
	            ';
            }

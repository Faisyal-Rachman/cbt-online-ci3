          ...
          $op1 = 4;
                            ...
                            foreach ($query_jawaban as $jawaban) {
                                ...
                                if($jawaban->soaljawaban_selected==1){
                                    $soal = $soal.'<div class="radio">'.$b.'. <label><input type="radio" onchange="jawab()" name="soal-jawaban" value="'.$jawaban->soaljawaban_jawaban_id.'" checked> '.$temp_jawaban.'</label></div>';
                                }else{
                                    $soal = $soal.'<div class="radio">'.$b.'. <label><input type="radio" onchange="jawab()" name="soal-jawaban" value="'.$jawaban->soaljawaban_jawaban_id.'" > '.$temp_jawaban.'</label></div>';
                                } 
                                $i++;
                            }
                        }

...
class Modul_topik extends Member_Controller {
    ...
    function get_datatable(){
	    ...
	    foreach ($query as $temp) {			
			...
			$jml_pilganda = $this->cbt_soal_model->count_by_kolomsoal('soal_topik_id', $temp->topik_id)->row()->objective;
			$jml_js = $this->cbt_soal_model->count_by_kolomsoal('soal_topik_id', $temp->topik_id)->row()->js;
			$jml_esai = $this->cbt_soal_model->count_by_kolomsoal('soal_topik_id', $temp->topik_id)->row()->esai;

            $record[] = $temp->topik_nama;
            $record[] = $temp->guru_pengampu;
			$record[] = $jml_soal.'-('.$jml_pilganda.' Opsi | '.$jml_js.' Objektif | '.$jml_esai.' Esai)';

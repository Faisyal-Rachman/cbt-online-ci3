	    ...
	    $posisi = $this->config->item('upload_path').'/topik_'.$tmn.'_'.$tmnt;
            ...
            $jawaban_table = '
            	<table class="table table-sm">
            		<tr>
                      <td colspan="4" align="left">'.$soal.'</td>
                    </tr>
            ';
            ...
            if($temp->soal_tipe==1){
	            ...
	            if($query_jawaban->num_rows()>0){
	            	...
	            	foreach ($query_jawaban as $jawaban) {
	            		...
	            		$jawaban_table = $jawaban_table.'
	            			<tr>
								  <td width="20%" class="text-right">'.$temp_pilihan.' '.$b.'.</td>
								  <td width="50%" style="ward-wrap:break-word">'.$temp_jawaban.'</td>
		                      	<td width="60%">'.$temp_benar.'</td>
            	...
            	$jawaban_table = $jawaban_table.'
            		<tr>
		                ...
		                <td width="70%" colspan="2">Jawaban</td>
		            </tr>
	            	<tr>
		            	
		                <td width="10%"><b>Skor '.$temp->tessoal_nilai.'</b></td>
		                <td width="70%" colspan="2"><div style="width:100%;"><pre style="white-space: pre-wrap;word-wrap: break-word;"><b>'.$temp->tessoal_jawaban_text.'</b></pre></div></td>
		            </tr>
	            ';
            }else if($temp->soal_tipe==3){
            	// Jika soal adalah soal Jawaban Singkat
            	$jawaban_table = $jawaban_table.'
            		<tr>
		            	<td width="12%"></td>
		                <td width="10%">Skor</td>
		                <td width="70%" colspan="2">Jawaban Singkat</td>
		            </tr>
	            	<tr>
		            	<td width="12%"></td>
		                <td width="10%">'.$temp->tessoal_nilai.'</td>
		                <td width="70%" colspan="2"><div style="width:100%;">'.$temp->tessoal_jawaban_text.'</div></td>
		            </tr>
	            ';
            }
            $jawaban_table = $jawaban_table.'</table>';

...
<table style="width: 400px;" class="responsive">
<tbody>
<tr>
<td style="width: 122px;" rowspan="2"><center><img src="'.$img1.'" width="45px" /></center></td>
<td style="width: 290px;" colspan="3"><center>
<div style="font-size: 11px; font-weight: bold;">'.$temp->tes_jenis.' <br /> '.$data['thn_sekolah'].'</div>
</center></td>
<td style="width: 265px;" rowspan="2"><center><img src="'.$img2.'" width="45px" /></center></td>
</tr>
...
<tr>
<td style="width: 350px;" colspan="5"><hr></td>
</tr>
<tr>
<td style="width: 350px;" colspan="5"><center><font style="font-size:11px;font-family:courier"> '.$loginujian.'</font></center></td>
</tr>
<tr>
<td style="width: 350px;" colspan="5"><center><strong>'.$temp->user_birthdate.'</strong></center></td>
</tr>
<tr>
...
<tr>
<td style="width: 119px;">Ujian</td>
<td style="width: 10px;">:</td>
<td style="width: 353px;"><b>'.$temp->tes_nama.' - '.$group.'</b></td>
<td style="width: 21px;">&nbsp;</td>
<td style="width: 165px;">&nbsp;</td>
</tr>
<tr>
<td style="width: 119px;">Waktu</td>
<td style="width: 10px;">:</td>
<td style="width: 353px;">'.date('d-m-Y  H:i', strtotime($temp->tes_begin_time)).'</td>
<td style="width: 21px;">&nbsp;</td>
<td style="width: 165px;">&nbsp;</td>
</tr>
<tr>

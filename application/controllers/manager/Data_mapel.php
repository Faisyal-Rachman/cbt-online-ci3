...
public function simpan(){
   ...
   $data = array(
	...
	function update(){
			extract($_POST);
			$topik_id=$id;
			$data['modul_aktif'] = $status;
			$this->cbt_modul_model->update('modul_id', $topik_id, $data);
...
*/
 ...
 function get_datatable(){
		...
		$i=$start;
			...
			$record[] = '<b data="'.$temp->modul_id.'" class="status_checks btn '.(($temp->modul_aktif)?'btn-success btn-sm' : 'btn-danger btn-sm').'">
			'.(($temp->modul_aktif)?'Aktif' : 'Nonaktif').'</b>';

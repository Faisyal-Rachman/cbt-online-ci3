...
class Tes_evaluasi extends Member_Controller {
    ...
    function get_datatable(){
	    ...
	    foreach ($query as $temp) {			
			...
			$record[] = ++$i;
            $record[] = $soal.'<font style="color:red;font-weight:bold;"> (Bobot : '.$temp->tes_score_right_essai.')</font>';
			...
			$record[] = $jawaban;
			$record[] = $temp->tessoal_nilai;
            $record[] = '<a onclick="evaluasi(\''.$temp->tessoal_id.'\',\''.$temp->tes_score_wrong.'\',\''.$temp->tes_score_right.'\')" style="cursor: pointer;" class="btn btn-primary btn-sm text-light">Evaluasi</a>';

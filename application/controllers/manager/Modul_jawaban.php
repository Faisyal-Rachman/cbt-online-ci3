    ...
    function get_datatable(){
	    ...
	    foreach ($query as $temp) {			
            ...
            $record[] = '<div style="text-align: center;">
            	<a onclick="edit(\''.$temp->jawaban_id.'\')" title="Edit Jawaban" style="cursor: pointer;"><i class="icon fa fa-edit fa-sm"></i></a>
            	<a onclick="hapus(\''.$temp->jawaban_id.'\')" title="Hapus Jawaban" style="cursor: pointer;"><i class="icon fa fa-trash fa-sm"></i></a>
            	</div>
            ';
